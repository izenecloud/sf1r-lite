...
require_rel 'exporter/nothing_exporter.rb'
require_rel 'exporter/collonly_exporter.rb'
require_rel 'exporter/visit_exporter.rb'
require_rel 'exporter/visit_item_exporter.rb'
require_rel 'exporter/purchase_item_exporter.rb'
...
#    @exporter_map['documents'] = NothingExporter.new
    @exporter_map['documents/log_group_label'] = NothingExporter.new
