#!/bin/bash
HOM=`dirname $0`
scp dev@izenesoft.cn:/data/B5M/config/b5mo.xml $HOM/
scp dev@izenesoft.cn:/data/B5M/config/b5mp.xml $HOM/
...
scp dev@izenesoft.cn:/data/B5M/config/guang.xml $HOM/
scp dev@izenesoft.cn:/data/B5M/config/guango.xml $HOM/
