 ...
 * @date Created <2012-11-08 10:25:36>
 *
...
void initializeDriverRouter(::izenelib::driver::Router& router, IService* service, bool enableTest)
{
...

    {
        ...
        handler_ptr mining_create_indexHandler(
            new handler_type(
                commands,
                &CommandsController::mining_create_index
            )
        );
        ...
        router.map(
            controllerName,
            "mining_create_index",
            mining_create_indexHandler.get()
        );
        mining_create_indexHandler.release();

        handler_ptr mining_searchHandler(
            new handler_type(
                commands,
                &CommandsController::mining_search
            )
        );
        ...
        router.map(
            controllerName,
            "mining_search",
            mining_searchHandler.get()
        );
        mining_searchHandler.release();
