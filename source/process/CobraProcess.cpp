...
#include <mining-manager/summarization-submanager/OpinionsClassficationManager.h>
...
void CobraProcess::initQuery()
{
    ...
    OpinionsClassficationManager::system_resource_path_ = SF1Config::get()->getResourceDir();
}
