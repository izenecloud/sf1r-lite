...
namespace sf1r
{
     ...
     *
     * @details
     * This class is not meant to be directly accessed but through classes that hold an instance of this
     * class as a member variable. E.g. PropertyConfigBase, IndexManagerPropertyConfig, etc.
     * These classes expose the interfaces to allow them to access part of the property data. 
     *
     * It is often the case that a user(manager) of this class only requires a portion of the configuration data.
     * In such case, it is encouraged to grant access to the user for only the data that are required.
     */
