#ifndef SF1R_B5MMANAGER_TICKETMATCHER_H
#define SF1R_B5MMANAGER_TICKETMATCHER_H 
...
namespace sf1r {
    ...
    class TicketMatcher{
        ...
        public:
            ...
            bool dd(const TicketMatcherAttach& other) const
            {
        ...
        typedef idmlib::dd::DupDetector<DocIdType, uint32_t, TicketMatcherAttach> DDType;
