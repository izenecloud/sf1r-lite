...
std::string OpinionsClassficationManager::system_resource_path_;
OpinionsClassficationManager::OpinionsClassficationManager(string cma_path,string path)
{
   // cma_path="/home/lscm/codebase/icma/db/icwb/utf8";
    ...
    string logpath=path+"/OpinionsClassficationManager.log";
...
OpinionsClassficationManager::~OpinionsClassficationManager()
{   
...
void OpinionsClassficationManager::loadAll(string path)
{ 
...
void OpinionsClassficationManager::load(vector<string>& vec,string pathname)
{
...
void OpinionsClassficationManager::load(vector<pair<string,string> >& vec,string pathname)
{
    ifstream in;
    in.open(pathname.c_str(), ios::in);
    if(in.is_open())
...
void  OpinionsClassficationManager::save(vector<string>& vec,string pathname)
{
    ofstream out;
...
void  OpinionsClassficationManager::save(vector<pair<string,string> >& vec,string pathname)
{
    ofstream out;
    out.open(pathname.c_str(), ios::out);
    for(int i=0;i<vec.size();i++)
...
void  OpinionsClassficationManager::saveSeclect(vector<string>& vec,string pathname)
{
    ofstream out;
    out.open(pathname.c_str(), ios::out);
...
void  OpinionsClassficationManager::saveAll(string path)
{
    sort();
...
vector<string> OpinionsClassficationManager::SegQuery(const std::string& query)
{
...
vector<string> OpinionsClassficationManager::SegWord(const std::string& Word)
{
...
void OpinionsClassficationManager::getWordFromTrainData()
{
...
bool OpinionsClassficationManager::isreverse(string word)
{
...
void OpinionsClassficationManager::reverseDeal(vector<string>& wordvec,bool& good)
{
...
void OpinionsClassficationManager::insertWord(string word,bool good)
{
       int storenum;
       int goodnum;
       int badnum;
...
void  OpinionsClassficationManager::ClassfyWord(string word)
{      
       int storenum;
       int goodnum;
       int badnum;
...
void  OpinionsClassficationManager::ClassfyWordVector()
{    
...
void OpinionsClassficationManager::getPairFromTrainData()
{
       for(int i=0;i<trainData.size();i++)
       { 
            vector<string> wordvec=SegQuery(trainData[i].first);
...
void OpinionsClassficationManager::inserPair(string word1,string word2,bool good)
{
       int storenum;
       int goodnum;
       int badnum;
...
double  OpinionsClassficationManager::PMI(string word1,string word2)
{
...
void  OpinionsClassficationManager::ClassfyPair(pair<string,string> p)
{
...
void  OpinionsClassficationManager::ClassfyPairVector(vector<pair<string,string> > p)
{
...
void  OpinionsClassficationManager::sort()
{
...
bool  OpinionsClassficationManager::include(string word,vector<string>& strvec)
{/*
...
bool  OpinionsClassficationManager::include(pair<string,string> wordpair,vector<pair<string,string> >& pairvec)
{
...
void OpinionsClassficationManager::insert(string word,int cat)
{
       int storenum=0;
       int goodnum=0;
       int uncommentnum=0;
...
int OpinionsClassficationManager::dealwithWordPair(string wordpair,bool& reverse)
{
...
int OpinionsClassficationManager::getResult(string Sentence)
{
...
std::pair<UString,UString> OpinionsClassficationManager::test(string Segment)
{    
      log<<"test"<<endl;
      //cout<<Segment<<endl;
      log<<Segment<<endl;
