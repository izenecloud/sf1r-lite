...
OntologyManager::OntologyManager(const std::string& container,
...
//used for t_faceted
OntologyManager::OntologyManager( std::string& container,
...
//, cooccurenceFile_(container_+"/cooccurence")
{
	...
	string sdbfile("/home/yode/test/doc_label_tf.dat");

	cout<<"sdb file is "<<sdbfile<<endl;
